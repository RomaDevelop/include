...
PlatformDependent::CreatePRVWRes CreateErrRes(QString text, HRESULT &hr)
{
...
PlatformDependent::CreatePRVWRes PlatformDependent::CreatePRVW(const QString & /*file_to_get_prvw*/)
{
	QMbError("CreatePRVW should place in separate file");
	return {};
